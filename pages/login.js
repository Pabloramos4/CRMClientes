...
export default function Login() {
  ...
  //Mutarion para crear nuevo usuario en APOLLO
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string().required("El password es requierido"),
    }),
    onSubmit: async (valores) => {
      ...
      try {
        ...
        console.log(data);
        //Guardar el Token el Local Storage
              ...
              <div className="mt-6">
                <form onSubmit={formik.handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      {loadingBtn === true ? <Digital /> : "Iniciar"}
                    </button>
                  </div>
                </form>
              </div>
